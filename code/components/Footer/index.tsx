        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Provide users with simple and practical free online tools to make daily tasks easier and more efficient. We are committed to becoming a powerful assistant in your digital life, 
                allowing everyone to easily complete operations anytime and anywhere and improve work efficiency.
                </p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright 2023-2024 &nbsp;
              <a href="/" rel="nofollow noopener"> Online Json.</a>
              All rights reserved.
            </p>
          </div>
        </div>
